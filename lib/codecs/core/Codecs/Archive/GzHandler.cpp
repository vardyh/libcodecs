...
STDMETHODIMP CHandler::GetProperty(UInt32 /* index */, PROPID propID,  PROPVARIANT *value)
{
  ...
  switch(propID)
  {
    ...
    case kpidHostOS: prop = kUnknownOS; break;
    ...
    Int32 testMode, IArchiveExtractCallback *extractCallback)
{
  ...
  HRESULT hr = extractCallback->SetOperationResult(outStreamSpec->_stream, opRes);
  outStream.Release();
  return hr;
  COM_TRY_END
}
...
static IInArchive *CreateArc() { return new NArchive::NGz::CHandler; }
#ifndef EXTRACT_ONLY
static IOutArchive *CreateArcOut() { return new NArchive::NGz::CHandler; }
#else
#define CreateArcOut 0
#endif

static CArcInfo g_ArcInfo =
{ ".gz", { 0x1F, 0x8B, 8 }, 3, CreateArc, CreateArcOut };
